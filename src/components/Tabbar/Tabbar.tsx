...
interface TabbarProps {
  onSelect: (title: string, component: ReactNode) => void;
  onClose: () => void;
}

const Tabbar: React.FC<TabbarProps> = ({ onSelect, onClose }) => {
  const TABBAR_DATA: TTabbarItem[] = [
    ...
    { title: "RSVP", logo: <Envelope size={32} />, component: <Rsvp onClose={onClose} /> },
  ];
